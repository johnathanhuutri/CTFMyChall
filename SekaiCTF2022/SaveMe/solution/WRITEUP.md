...
Stage 1: Using format string bug to change `putc@got` into `pop rbx ; pop rbp ; pop r12 ; pop r13 ; pop r14 ; pop r15 ; ret
` to make it pop and align the stack

Stage 2: Conduct a egg hunting to find the chunk contains the flag

> Remember that scanf don't like whitechar
